...
/// LaminaSort is allowed to reorder. Nothing outside it is ever addressed.
struct SortRegion {
...
public:
    ...
    static std::optional<SortRegion> selectRegion(ContainerScreenController& controller, Config const& config);
